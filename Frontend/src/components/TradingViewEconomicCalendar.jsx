...
export default function TradingViewEconomicCalendar({ totalHeight = 420 }) {
    ...
    useEffect(() => {
        ...
        script.innerHTML = JSON.stringify({
            ...
            countryFilter: "us,eu,jp,cn,gb,au,ca,nz,ch",
        });
        ...
        <section style={{ ...styles.wrapper, height: totalHeight }}>
            <div style={styles.header}>
                <div>
                    ...
                    <p style={styles.subtitle}>Key macro events before you trade</p>
                </div>
            </div>
